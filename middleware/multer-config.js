...
// Définition des types de MIME_TYPE obtenu depuis le frontend
const MIME_TYPES = {
  'image/jpg': 'jpg',
  'image/jpeg': 'jpeg',
  'image/png': 'png',
...
const storage = multer.diskStorage({
  ...
  // La fonction filename indique d'utiliser le nom d'origine en remplaçant les espaces par des underscore + un timestamp
